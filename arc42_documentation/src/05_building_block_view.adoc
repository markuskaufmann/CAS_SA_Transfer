...
|Domäne
|Implementiert den Bestandteil der Businesslogik gemäss dem definierten link:08_concepts.adoc#section-concepts[Domänenmodell], welcher für die Verarbeitung der Daten verantwortlich ist, die von den Patient*innen während der Ausführung einer Therapie-Session aufgezeichnet werden.
